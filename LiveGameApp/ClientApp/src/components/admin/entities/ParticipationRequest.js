...
export const ParticipationRequestList = props => (
    <List filters={<ParticipationRequestFilter />} {...props}>
...
export const ParticipationRequestEdit = props => (
    <Edit {...props}>
        <SimpleForm>
...
export const ParticipationRequestCreate = props => (
    <Create {...props}>
        <SimpleForm>
            <TextInput source="Message" />
            <ReferenceInput source="SenderId" reference="AppUsers"><SelectInput optionText="Username" /></ReferenceInput>
...
export const ParticipationRequestFilter = (props) => (
    <Filter {...props}>
